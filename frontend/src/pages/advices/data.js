...
const advicesData = [
  ...
  },
  {
    logo: Infection,
    text:
      "اجتناب التجمعات و الإحتكاك المباشر مع الأشخاص عن طريق المصافحة، العناق أو التقبيل"
  },
  {
    logo: StayHome,
    text:
      "التزام المكوث في المنزل وعدم الخروج إلا عند الضرورة (التبضع، التطبيب، الإلتحاق بالعمل ...)"
  }
];
